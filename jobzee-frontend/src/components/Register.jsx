...
const Register = () => {
  ...
  useEffect(() => {
    ...
    setIsValid(allFieldsValid && Object.values(form).every(x => x !== ""));
  }, [form]);
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-100">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-1/2 p-8 justify-center items-center">
        <div className="relative w-full max-w-lg rounded-3xl">
          ...
          <div className="pointer-events-none absolute -top-16 -left-16 w-72 h-72 bg-gradient-to-br from-indigo-400/30 to-sky-300/30 rounded-full blur-3xl"></div>
          <div className="pointer-events-none absolute -bottom-20 -right-20 w-80 h-80 bg-gradient-to-tr from-fuchsia-400/25 to-violet-300/25 rounded-full blur-3xl"></div>

          {/* Card */}
          <div className="relative bg-slate-900/70 backdrop-blur-xl border border-white/10 rounded-3xl p-8 text-slate-100 shadow-2xl shadow-black/40">
            {/* Job-related line drawing */}
            <div className="flex justify-center mb-6">
              <svg width="260" height="160" viewBox="0 0 520 320" className="opacity-95">
                <g fill="none" stroke="#c7d2fe" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
                  {/* Briefcase */}
                  <rect x="60" y="110" width="180" height="110" rx="12"/>
                  <path d="M90 110v-20a20 20 0 0 1 20-20h80a20 20 0 0 1 20 20v20"/>
                  <path d="M60 155h180"/>
                  <rect x="135" y="150" width="30" height="20" rx="4"/>
                  {/* Resume sheet */}
                  <rect x="280" y="70" width="160" height="200" rx="12"/>
                  <circle cx="320" cy="110" r="14"/>
                  <path d="M350 110h60M300 150h120M300 180h120M300 210h90"/>
                  {/* Magnifier */}
...
<<<<<<< HEAD
            ...
            <div className="mx-auto mb-3 w-14 h-14 rounded-2xl bg-gradient-to-tr from-indigo-500 to-violet-500 shadow-lg shadow-indigo-900/40 flex items-center justify-center">
              <svg viewBox="0 0 24 24" className="w-7 h-7 text-white" fill="none" stroke="currentColor" strokeWidth="1.8">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8 7h8M6 11h12M9 15h6" />
              </svg>
            </div>
            <h2 className="text-3xl font-bold text-center mb-2 tracking-tight">Create a Job‑Ready Profile</h2>
            <p className="text-slate-300 text-center mb-6">Upload your resume, track applications, and let recruiters discover you.</p>
            <ul className="grid grid-cols-2 gap-3 text-sm text-slate-200">
              <li className="flex items-center"><span className="mr-2 inline-flex h-5 w-5 items-center justify-center rounded-full bg-indigo-500/20 text-indigo-300"><svg viewBox="0 0 24 24" className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 6L9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg></span>Smart profile builder</li>
