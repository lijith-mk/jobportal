...
exports.loginEmployer = async (req, res) => {
  try {
    ...
    // Fire-and-forget: log successful employer sign-in
    try {
      EmployerSignIn.create({
        employerId: employer._id,
        companyName: employer.companyName,
        companyEmail: employer.companyEmail,
...
exports.googleAuth = async (req, res) => {
  try {
    ...
    if (employer) {
      ...
      // Fire-and-forget: log successful Google sign-in
      try {
        EmployerSignIn.create({
          employerId: employer._id,
          companyName: employer.companyName,
      ...
      // Fire-and-forget: log successful Google sign-in for newly created employer
      try {
        EmployerSignIn.create({
          employerId: employer._id,
          companyName: employer.companyName,
