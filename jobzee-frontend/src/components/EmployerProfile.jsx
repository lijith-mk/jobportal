          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 sticky top-8">
            ...
            <div className="text-center mb-8">
              <div className="relative inline-block">
                <div className="w-32 h-32 rounded-full bg-gradient-to-r from-purple-500 to-orange-500 p-1 shadow-lg">
            ...
            <div className="space-y-3">
              {!isEditing ? (
                <button
                  ...
                  className="w-full bg-gradient-to-r from-purple-600 to-orange-500 text-white py-3 px-4 rounded-xl font-medium hover:from-purple-700 hover:to-orange-600 transition-all duration-200 transform hover:scale-105 shadow-lg"
                >
                  Edit Profile
                </button>
              ) : (
